...
Si vous utilisez Roon et avez un Mac sous macOS 15+, un DMG est disponible. L'app n'est pas signee Apple (pas de compte Developer), il faut donc faire clic droit > Ouvrir la premiere fois.
